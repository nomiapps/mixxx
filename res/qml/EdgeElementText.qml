...
Item {
    ...
    readonly property string keyText: (root.loaded && root.player.keyText) ? root.player.keyText : "--"
    ...
    readonly property string titleText: root.player ? (root.player.artist + " - " + root.player.title) : ""
